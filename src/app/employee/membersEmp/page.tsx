...
export default function EmpMembersPage() {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`/api/employee/members/${selectedMember.id}`, {
        method: "PATCH",
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      await fetch(`/api/employee/members/${selectedMember.id}`, {
        method: "DELETE",
      });
  ...
  const handleToggleStatus = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `/api/employee/members/${selectedMember.id}/status`,
        {
          method: "PATCH",
          headers: { "Content-Type": "application/json" },
    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.title}>
          ...
          <Link href="/employee/membersEmp/addMem">
